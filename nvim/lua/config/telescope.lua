return {
  {
    ...
    keys = {
      ...
      { "<leader>b", "<cmd>Telescope buffers sort_mru=true ignore_current_buffer=true<cr>", desc = "Buffers" },
      ...
      { "<leader>su", require("utils").telescope("live_grep"), desc = "Grep (Root Dir)" },
    ...
    config = function(_, _)
      ...
      local custom_pickers = require("config.picker")
      ...
      -- fg_bg("TelescopeResultsTitle", colors.darker_black, colors.bue)
    end,
  },
  {
    "stevearc/aerial.nvim",

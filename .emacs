...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (markdown-mode+ docker-compose-mode dockerfile-mode markdown-mode avy company-statistics company-tern tern tide js2-mode go-mode flycheck json-mode ace-window spaceline web-mode company neotree evil-commentary key-chord color-theme color-theme-modern evil-leader evil))))
(custom-set-faces
